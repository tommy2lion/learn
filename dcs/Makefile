...
# ── R-15 part 2: build-time metadata ───────────────────────────────
...
$(CLI_EXE): $(FW_PLATFORM_SRC) $(FW_PLATFORM_HDR) $(DOMAIN_SRC) $(DOMAIN_HDR) \
            $(BUILD_INFO_SRC) $(BUILD_INFO_HDR) $(CLI_SRC)
	$(CC) $(CFLAGS) $(FW_PLATFORM_SRC) $(DOMAIN_SRC) $(BUILD_INFO_SRC) $(CLI_SRC) \
		-o $@ -lcomdlg32
...
$(GUI_EXE): $(FW_PLATFORM_SRC) $(FW_GRAPH_SRC) $(FW_WIDGET_SRC) \
	...
	$(CC) $(CFLAGS) -I $(RAYLIB_INC) \
		...
		$(DOMAIN_SRC) $(APP_SRC) $(BUILD_INFO_SRC) $(GUI_SRC) \
		-o $@ -lcomdlg32 $(RAYLIB_LDFL)
